...
then
	splitrim --inFile=$FASTQ --ascii=$TRIM_ASCI --fixL=$TRIM_FIXL --recycle --minQ=$TRIM_MINQ --prefix=$PREFIX --outPath=$OUTPATH/../../sequence_processed/splitrim_fixL${TRIM_FIXL}Q${TRIM_MINQ}
else
