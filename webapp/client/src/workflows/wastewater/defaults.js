...
export const bulkWorkflowOptions = [
  { value: 'wastewater', label: workflowList['wastewater'].label },
]

export const workflowOptions = [
  { value: 'metaG', label: workflowList['metaG'].label },
  { value: 'metaT', label: workflowList['metaT'].label },
]
