...
const config = {
  ...
  NEXTFLOW: {
    ...
    //Directory for apptainer images 
    IMG_CACHE_DIR: process.env.NEXTFLOW_IMG_CACHE_DIR,
    //Reference data directory for workflows
    REFDATA: process.env.NEXTFLOW_REFDATA,
    //Temporary files generated by workflows
    TMPDIR: process.env.NEXTFLOW_TMPDIR || '/tmp',
  },
  CROMWELL: {
